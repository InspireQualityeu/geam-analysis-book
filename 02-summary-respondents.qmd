...
```{r}
#| label: tbl-sdem004
#| tbl-cap: "Frequency table for SDEM004"
...
:::{.callout-note}
The most recent GEAM version (since v3.0), "Other" as answer-option has been replaced with "Prefer to self-identify as" to avoid othering. Some data uses results of previous GEAM versions, the "Other" label still is visible in frequency tables. 
:::
...
#| tbl-cap: "Frequency table of country of birth"
...
#| tbl-cap: "Frequency table of trans history"
...
#| tbl-cap: "Frequency table of sexual orientation"
...
#| tbl-cap: "Frequency table of disability and health impairments"
...
#| echo: false
#| label: tbl-edu-level
#| tbl-cap: "Frequency table of highest educational level of respondent"
...
#| echo: false
#| label: tbl-wcjc010
#| tbl-cap: "Frequency table of part-time/full-time contract"
