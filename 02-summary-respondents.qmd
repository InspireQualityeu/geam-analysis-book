...
::: column-margin
The R code for producing simple frequency tables is shown for the first table of this chapter. A custom function `table_frq()` has been defined in the `util/common.R` file. All subsequent tables follow the same code but are hidden to improve readability of the text. 
:::
