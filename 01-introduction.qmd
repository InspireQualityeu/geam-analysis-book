...
This handbook is intended for gender equality practitioners who have collected data using the Gender Equality Audit and Monitoring (GEAM) tool within their organisations. The target audience includes professionals, gender specialists, administrative staff, and other stakeholders interested in promoting gender equality through the appropriate use of data. 
...
We recommend in any case that equality practitioners with little statistical background consult and collaborate with a statistics expert. Expert guidance can facilitate the interpretation of results and ensure that conclusions drawn from the data are robust and reliable. This collaborative approach will maximise the impact of the analysis and its application in gender equality strategies and policies. 

Ideally, this book provides a starting point for engaging in a dialog between equality practitioners, data or statistical experts and employees or students about equality in their organisation. As such, we hope that it will be interesting and useful for statisticians to learn about gender and for gender equality practitioners interested in quantitative data analysis. 


## How to use this book

Having conducted many GEAM surveys across European academic organisations has shown that often the collected data is not exploited to its full potential. Most analysis of GEAM data remains on a descriptive level. While a useful first step, more sophisticated analysis should be carried out to detect intersecting inequalities. In order to facilitate a more in-depth analysis, the book has been divided into two parts. 

**Part I** introduces main some statistical techniques to be used beyond descriptive statistics. This includes very established techniques used to detect (gender) gaps (@sec-ch03-gaps), compare results in time (see @sec-ch04-compare-time) or between organisations (see @sec-ch05-compare-org), or newer approaches to carry out an intersectional analysis (see @sec-ch06-intersectional). 

**Part II** then connects these statistical techniques to content. The different chapters aim to provide an overview of the main GEAM variables and how they relate to specific equality themes such as GEP design (see @sec-ch07-gep-design), work-life balance and conflict (see @sec-ch08-career) among others. Hence, part II is especially helpful for readers that are interested in how to approach certain key equality topics with their data. 
...
The GEAM survey framework, including its many translations, is a collective endeavour that has been built by many contributions from European equality practitioners. Its success reflects this open and collaborative way of working. The GEAM questionnaire, handbooks and reporting infrastructure is available for free online.
