...
# Analysing Work-life conflict {#sec-ch07-career}
...
-   type of contract (`WCJC010`) (see @sec-ch03-gaps-type-contract)
-   care responsibilties (`WCWI006` and `WCWI008` )
-   parental leave policies (`WCWI011a` and `WCWI011b`)
-   work-family conflict (`WorkFamConfISSP`)

## Care responsibilities

Women tend to have considerably more care responsibilities than men, both for children but also for dependent adults [@Gimenez-NadalGenderGapTime2020]. The GEAM covers both of these aspects using question `WCWI006` and `WCWI008`.
...
The GEAM covers several issues realted to flexible work arrangements in question `WCWI005`, including:
...
```{r}
#| label: code-flexible-work-mean-WCWI005-geam01
