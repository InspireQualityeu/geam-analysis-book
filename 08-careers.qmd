...
For example, by using @lst-crosstab-plot-code, we can generate stacked barcharts to visualise the relative proportion of women and men with care responsibilities: 
