...
At the same time, however, the shares of employees perceiving deeper, more sustainable effects of the implemented activities (such as ensuring effective equal treatment) did not increase substantially and remained at an unsatisfactory level. In 2020, 42% of respondents agreed that men and women are treated equally in the institution and 43% disagreed with this statement. To compare, in 2025 the numbers were respectively – 41% and 33%. We observe the increase of answers *'Neither agree nor disagree'*, but not in the percentage of those who agree with this statement. Still, the negative responses were more frequent. When it comes to responsiveness of the institution to concerns about gender equality, while in 2020, 33% of respondents believed that the institution is not responsive to concerns about gender equality, in 2025 this number dropped to 21% – suggesting less critical opinions on institution’s responsiveness. Still, in both editions, about half of respondents choose the middle category (*'Neither agree nor disagree'*), and percentage of those with positive opinions remained unchanged. Similar distribution of opinions can be observed in the question on institution’s commitment to promoting gender equality.
...
+===========+====================================================================================================================================================+====================+
| `WCJC019` | *We are interested in the training opportunities available to you. Please indicate which, if any, of the following you have received training in.* |                    |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ001`   | Administrative tasks related to managing other members of staff (e.g. conducting annual performance reviews, induction processes for new staff)    | \[1\] not-checked\ |
|           |                                                                                                                                                    | \[2\] checked      |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ002`   | Leadership development (e.g. preparation for senior managerial appointments)                                                                       | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ003`   | Professional development                                                                                                                           | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ004`   | Grant or funding application skills                                                                                                                | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ005`   | Teaching and/or student supervision                                                                                                                | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ006`   | Project management training (e.g. leading project administration, budgets, etc.)                                                                   | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ007`   | Unconscious bias, equality, diversity, and inclusion training                                                                                      | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ008`   | Bullying/harassment at work                                                                                                                        | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ009`   | Sexual and/or sexist or gender harassment                                                                                                          | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ010`   | Accounting or financial management accreditation programmes                                                                                        | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ011`   | IT courses (e.g., training related to using specific software programs, website design, etc.)                                                      | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ012`   | Job shadowing or placements (e.g. within another department or faculty to develop skills required for progression)                                 | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ013`   | Human Resources (HR) courses or accreditation programs                                                                                             | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ014`   | Course on legal regulations / changes                                                                                                              | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+
| `SQ015`   | None of the above                                                                                                                                  | \- same as `SQ001` |
+-----------+----------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+

: Training opportunities received, multiple-choise answer options for `WCJC019`.
...
: Barrier to training opportunties - answer options to multip-choice question `WCJC021`
